  ...
  <div className="min-h-screen bg-background flex flex-col md:overflow-visible md:h-auto overflow-y-auto h-screen overscroll-none">
    ...
    <section className="py-16 md:py-24">
      <div className="container max-w-3xl">
        <h1 className="text-2xl md:text-4xl tracking-wide-brand text-foreground font-light mb-4">TERMS OF USE</h1>
        <p className="text-sm text-muted-foreground mb-10">Kushtet e përdorimit të faqes sonë të internetit.</p>
