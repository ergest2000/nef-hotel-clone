      ...
      <div className="absolute inset-0 flex items-center">
        <div className="container">
          <div className={`max-w-lg transition-all duration-700 ${isAnimating ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-light text-foreground leading-tight whitespace-pre-line" style={{ fontSize: `var(--ds-font-size-h1, 36px)`, fontWeight: `var(--ds-font-weight, 300)`, letterSpacing: '0', textTransform: 'none' }}>
