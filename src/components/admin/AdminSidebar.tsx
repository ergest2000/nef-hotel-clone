...
const menuItems: { key: string; label: string; icon: any; group: string; roles?: RoleAccess }[] = [
  ...
  { key: "company", label: "Rreth Nesh", icon: Building2, group: "pages", roles: ["admin"] },
  { key: "clients", label: "Klientët", icon: Users, group: "pages", roles: ["admin"] },
  { key: "tailor-made", label: "Tekstile të Personalizuara", icon: Scissors, group: "pages", roles: ["admin"] },
  { key: "certifications", label: "Certifikimet", icon: Award, group: "pages", roles: ["admin"] },
  { key: "contact", label: "Kontakti", icon: Phone, group: "pages", roles: ["admin"] },
  ...
  { key: "certifications-logos", label: "Certifications Logos", icon: Award, group: "content", roles: ["admin", "manager", "editor"] },
        ...
        <div className="flex items-center gap-3 px-3 py-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              <span className="text-[11px] font-medium text-[hsl(207,56%,25%)] tracking-wide">EGJEU</span>
              <span className="text-[9px] text-muted-foreground">{panelLabel}</span>
            </div>
          )}
        </div>
      </SidebarHeader>
